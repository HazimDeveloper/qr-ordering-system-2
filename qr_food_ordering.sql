...
('admin', 'admin@restaurant.com', '$2a$12$zZlJHnRNvSLKnn9vc68UiOKj8RU6MmTtkrTU8Q.tqeTl00kKrqGMm', 'staff', NOW()),
('customer1', 'customer@test.com', '$2a$12$zZlJHnRNvSLKnn9vc68UiOKj8RU6MmTtkrTU8Q.tqeTl00kKrqGMm', 'customer', NOW());
...
('Claypot Rice', 'A delicious one-pot meal of tender, succulent chicken pieces and rice.', 9.00, 'claypot_rice.jpeg', NOW(), 1, 'Main Course'),
('Nasi Lemak', 'Fragrant rice cooked in coconut milk, served with sambal, anchovies, peanuts, boiled egg, and cucumber.', 7.50, 'nasi_lemak.jpg', NOW(), 1, 'Main Course'),
('Mee Goreng Mamak', 'Spicy stir-fried noodles with egg, tofu, vegetables, and a tangy sauce.', 7.00, 'mee_goreng_mamak.jpg', NOW(), 1, 'Main Course'),
('Satay', 'Grilled skewered meat served with peanut sauce, rice cakes, and cucumber.', 10.00, 'sate.jpg', NOW(), 1, 'Appetizer'),
('Roti Canai', 'Flaky flatbread served with dhal or curry.', 3.50, 'roti_canai.jpg', NOW(), 1, 'Appetizer'),
('Teh Tarik', 'Traditional pulled milk tea, creamy and frothy.', 2.50, 'teh_tarik.jpg', NOW(), 1, 'Beverage'),
('Cendol', 'Iced dessert with green rice flour jelly, coconut milk, and palm sugar syrup.', 4.00, 'cendol.jpg', NOW(), 1, 'Dessert'),
('Asam Pedas', 'Spicy and sour fish stew with vegetables.', 11.00, 'asam_pedas.jpg', NOW(), 1, 'Main Course'),
('Rendang Daging', 'Slow-cooked beef in coconut milk and spices.', 13.00, 'rendang_daging.webp', NOW(), 1, 'Main Course');
