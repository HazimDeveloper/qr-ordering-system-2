...
<?php if ($success): ?>
    ...
    <div style="text-align: center; margin: 30px 0;">
        <a href="order_history_enhanced.php" class="btn">View Order History</a>
        <a href="guest_menu.php" class="btn btn-secondary">Order Again</a>
    </div>
<?php else: ?>
    <!-- QR Code Information -->
    <?php if ($qr_table): ?>
    ...
    <div style="text-align: center; margin: 20px 0;">
        <a href="guest_cart.php" class="btn btn-secondary">Back to Cart</a>
    </div>
<?php endif; ?>
